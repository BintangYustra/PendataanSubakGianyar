<?php
class DashboardOperatorListSubak extends CI_Controller {
	...
	public function index()
	{
        ...
        $data['totalsubak'] = $this-> FunctionModel -> pagination($config['per_page'] ,$data['start']);
    ...
    {		
		...
		// ];
		// $this->UpdateModel->update_tb_perahyangan_pura_bedugul_ada($id_subak, $update_tb_perahyangan_pura_bedugul_ada);
		...
		$this->UpdateModel->update_tb_pawongan($id_subak, $update_tb_pawongan);
		...
		// $pura = $this->UpdateModel->get_perahyanganpurabedugulada_by_id($id_perahyangan_pura_bedugul_ada);
		...
		// 	}
		// }
		// $this->UpdateModel->update_inventaris($id_perahyangan_pura_bedugul_ada, $data_inventaris);
		...
		// 	}
		// }
		// $this->UpdateModel->update_aci_aci($id_perahyangan_pura_bedugul_ada, $data_aci_aci_subak);
		...
		if (!empty($nama_penyakap)) {
			...
			$this->UpdateModel->update_nama_penyakap($id_pawongan, $data_nama_penyakap);
		}
		...
		if (!empty($nama_perarem)) {
			...
			$this->UpdateModel->update_nama_perarem($id_pawongan, $data_nama_perarem);
		}
		...
		if (!empty($tanaman_pokok)) {
			...
			$this->UpdateModel->update_tanaman_pokok($id_palemahan, $data_tanaman_pokok);
		}
		...
		if (!empty($jenis_tanaman_pokok)) {
			...
			$this->UpdateModel->update_jenis_tanaman_pokok($id_palemahan, $data_jenis_tanaman);
		}
		...
		if (!empty($hama)) {
			...
			$this->UpdateModel->update_hama($id_palemahan, $data_hama);
		}
		...
		if (!empty($nama_bantuan)) {
			...
			$this->UpdateModel->update_bantuan_pemerintah($id_palemahan, $data_bantuan);
		}
		...
		redirect(base_url('DashboardOperatorListSubak'));
    }
}